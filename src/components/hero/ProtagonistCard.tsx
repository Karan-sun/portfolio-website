...
export const ProtagonistCard = () => {
  ...
  return (
    <div className="relative z-10 manga-panel p-0 mt-6 max-w-3xl w-full mx-auto flex flex-col md:flex-row shadow-[0_0_30px_rgba(230,57,70,0.15)] group">

      {/* Top Banner indicating profile style */}
      <div className="absolute -top-1 left-6 bg-[#E63946] px-4 py-1 z-20 border-2 border-black rotate-[-2deg]">
      ...
      <div className="bg-[#1D3557] md:w-2/5 p-6 flex flex-col justify-center items-center relative overflow-hidden text-center md:border-r-4 border-black">
        ...
        <div className="font-share text-[#A8DADC] text-xs uppercase tracking-widest opacity-80 mb-2">
          {!isScanned ? "SCANNING BIOMETRICS..." : "BIOMETRICS VERIFIED"}
        </div>
